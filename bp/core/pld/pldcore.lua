...
function core.get()
    ...
    self["WSNAME"]              = self.settings["WSNAME"] or "Savage Blade"
    ...
    self["SEKKA"]               = self.settings["SEKKA"] or "Savage Blade"
    ...
    self.handleAutomation = function()
        ...
        if bp then
            ...
            if helpers['queue'].ready and not helpers['actions'].moving and bp.settings['Enabled'] then
                ...
                -- CURING ONLY IF MAJESTY IS UP.
                if helpers['buffs'].buffActive(621) then
                ...
                if player.status == 1 then
                    ...
                    if self.getSetting('JA') and helpers['actions'].canAct() then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            if helpers['buffs'].buffActive(116) and helpers['buffs'].buffActive(403) then
                                ...
                                -- MAJESTY.
                                if not helpers['buffs'].buffActive(621) and helpers['actions'].isReady('JA', "Majesty") then
                                    helpers['queue'].add(bp.JA["Majesty"], player)
                                end
                    ...
                    if self.getSetting('HATE') and target then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            if target and helpers['actions'].canCast() and helpers['actions'].isReady('MA', "Flash") then
                                ...
                                if helpers['actions'].canAct() and helpers['actions'].isReady('JA', "Divine Emblem") then
                                    helpers['queue'].add(bp.JA["Divine Emblem"], player)
                                    helpers['queue'].add(bp.MA["Flash"], target)
                            ...
                            if os.clock()-timers.hate > self.getSetting('HATE DELAY') then
                                ...
                                -- SHIELD BASH.
                                if helpers['actions'].isReady('JA', "Shield Bash") and target then
                                    helpers['queue'].add(bp.JA["Shield Bash"], target)
                                    timers.hate = os.clock()
                                
                                -- RAMPART.
                                elseif not helpers['buffs'].buffActive(623) and helpers['actions'].isReady('JA', "Rampart") and target then
                                    helpers['queue'].add(bp.JA["Rampart"], player)
                                    timers.hate = os.clock()
                                
                                -- SENTINEL.
                                elseif not helpers['buffs'].buffActive(62) and helpers['actions'].isReady('JA', "Sentinel") and target then
                                    helpers['queue'].add(bp.JA["Sentinel"], player)
                                    timers.hate = os.clock()
                                
                                -- PALISADE.
                                elseif not helpers['buffs'].buffActive(478) and helpers['actions'].isReady('JA', "Palisade") and target then
                                    helpers['queue'].add(bp.JA["Palisade"], player)
                                    timers.hate = os.clock()
                                
                                -- FEALTY.
                                elseif not helpers['buffs'].buffActive(344) and helpers['actions'].isReady('JA', "Fealty") and target then
                                    helpers['queue'].add(bp.JA["Fealty"], player)
                                    timers.hate = os.clock()
                    ...
                    if bp.helpers['buffs'].enabled then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            if (not helpers['buffs'].buffActive(116) or not helpers['buffs'].buffActive(403) or not helpers['buffs'].buffActive(621)) then

                                -- PHALANX.
                                if not helpers['buffs'].buffActive(116) and helpers['actions'].isReady('MA', "Phalanx") and helpers['actions'].canCast() then
                                    helpers['queue'].add(bp.MA["Phalanx"], player)

                                -- REPRISAL
                                elseif not helpers['buffs'].buffActive(403) and helpers['actions'].isReady('MA', "Reprisal") and helpers['actions'].canCast() and target then
                                    helpers['queue'].add(bp.MA["Reprisal"], player)

                                -- MAJESTY.
                                elseif not helpers['buffs'].buffActive(621) and helpers['actions'].isReady('JA', "Majesty") and helpers['actions'].canAct() then
                                    helpers['queue'].add(bp.JA["Majesty"], player)

                                end

                            elseif helpers['actions'].canCast() and target then

                                -- CRUSADE.
                                if helpers['actions'].isReady('MA', "Crusade") and not helpers['buffs'].buffActive(289) then
                                    helpers['queue'].add(bp.MA["Crusade"], player)

                                -- ENLIGHT.
                                elseif not helpers['buffs'].buffActive(274) then

                                    if self.getSetting('JOB POINTS') < 100 and helpers['actions'].isReady('MA', "Enlight") then
                                        helpers['queue'].add(bp.MA["Enlight"], player)

                                    elseif helpers['actions'].isReady('MA', "Enlight II") then
                                        helpers['queue'].add(bp.MA["Enlight II"], player)
                        ...
                        elseif player.sub_job == "BLU" then
                            ...
                            -- COCOON.
                            if helpers['buffs'].buffActive(93) and helpers['actions'].isReady('MA', "Cocoon") then
                                helpers['queue'].add(bp.MA["Cocoon"], player)
                            end
