                    ...
                    if self.getSetting('JA') and helpers['actions'].canAct() then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            if helpers['buffs'].buffActive(116) and helpers['buffs'].buffActive(403) then
                                ...
                                -- MAJESTY.
                                if not helpers['buffs'].buffActive(621) and helpers['actions'].isReady(bp, 'JA', "Majesty") then
                                    helpers['queue'].add(bp, bp.JA["Majesty"], player)
                                end

                                -- CHIVALRY.
                                if helpers['actions'].isReady(bp, 'JA', "Chivalry") and player['vitals'].tp >= self.getSetting('CHIVALRY') then
                                    helpers['queue'].add(bp, bp.JA["Chivalry"], player)
                                end
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            if target and helpers['actions'].canCast() and helpers['actions'].isReady(bp, 'MA', "Flash") then
                                ...
                                if helpers['actions'].canAct() and helpers['actions'].isReady(bp, 'JA', "Divine Emblem") then
                                    helpers['queue'].add(bp, bp.JA["Divine Emblem"], player)
                                    helpers['queue'].add(bp, bp.MA["Flash"], target)
                    ...
                    if self.getSetting('BUFFS') then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            elseif helpers['actions'].canCast() and target then
                                ...
                                -- CRUSADE.
                                if helpers['actions'].isReady(bp, 'MA', "Crusade") and not helpers['buffs'].buffActive(289) then
                                ...
                                elseif not helpers['buffs'].buffActive(274) then
                                    ...
                                    elseif helpers['actions'].isReady(bp, 'MA', "Enlight II") then
                                        helpers['queue'].add(bp, bp.MA["Enlight II"], player)
                        ...
                        elseif player.sub_job == "BLU" then
                            ...
                            -- COCOON.
                            if helpers['buffs'].buffActive(93) and helpers['actions'].isReady(bp, 'MA', "Cocoon") then
                                helpers['queue'].add(bp, bp.MA["Cocoon"], player)
                            end
