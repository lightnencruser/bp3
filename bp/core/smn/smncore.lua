        ...
        if commands and commands[1] then
            ...
            elseif command == 'bpr' then
                ...
                if self.getSetting('RAGE') < max then
                    self.setSetting('RAGE', self.getSetting('RAGE')+1)
            ...
            elseif command == 'bpw' then
                ...
                if self.getSetting('WARD') < max then
                    self.setSetting('WARD', self.getSetting('WARD')+1)
                ...
                if player.status == 1 then
                                ...
                                for _,v in pairs(skills.list) do
                                    ...
                                    if helpers['actions'].isReady('MA', v) and not helpers['queue'].inQueue(bp.MA[v]) then
                                        ...
                                        elseif bp.skillup[self.getSetting('SKILLS')].target == 'me' then
                                            ...
                                            if pet then
                                                helpers['queue'].add(bp.JA['Release'], 'me')
                    ...
                    if self.getSetting('PET') and helpers['actions'].canCast() then
                        ...
                        if not pet then
                            ...
                            if helpers['actions'].isReady('MA', self.getSetting('SUMMON')) and helpers['actions'].canCast() then
                                helpers['queue'].add(bp.MA[self.getSetting('SUMMON')], player)
                            end
                        ...
                        elseif pet and target then
                            ...
                            if pet.status == 1 and helpers['actions'].canAct() and helpers['actions'].isReady('JA', 'Blood Pact: Rage') then
                                ...
                                if self.getSetting('1HR') and helpers['actions'].isReady('JA', 'Astral Flow') and helpers['actions'].isReady('JA', 'Astral Conduit') then
                                    ...
                                    if helpers['actions'].isReady('JA', 'Mana Cede') then
                                        helpers['queue'].addToFront(bp.JA['Mana Cede'], player)
                                    end
                            ...
                            elseif pet.status == 0 then
                                helpers['queue'].add(bp.JA['Assault'], target)
                        ...
                        if player.sub_job == "RDM" then
                            ...
                            if self.getSetting('CONVERT') and player['vitals'].hpp >= self.getSetting('CONVERT HPP') and player['vitals'].mpp <= self.getSetting('CONVERT MPP') then
                                ...
                                if helpers['actions'].isReady('JA', "Convert") then
                                    helpers['queue'].addToFront(bp.MA["Cure IV"], player)
                                    helpers['queue'].addToFront(bp.JA["Convert"], player)
