                ...
                if player.status == 1 then
                        ...
                        if player.main_job == 'RUN' then
                            ...
                            if active > 0 then
                                ...
                                if active == 3 and (runes[1].en ~= 'Tenebrae' and runes[2].en ~= 'Tenebrae' and runes[3].en ~= 'Tenebrae') then 
                                    ...
                                    if player['vitals'].hpp < self.getSetting('VPULSE HPP') and helpers['actions'].isReady('JA', 'Vivacious Pulse') then
                                        helpers['queue'].add(bp.JA['Vivacious Pulse'], player)
                                    end

                                -- MPP THRESHOLD LOGIC.
                                elseif active == 3 and (runes[1].en == 'Tenebrae' or runes[2].en == 'Tenebrae' or runes[3].en == 'Tenebrae') and helpers['actions'].isReady('JA', 'Vivacious Pulse') then
                                ...
                                -- BATTUTA.
                                if helpers['actions'].isReady('JA', 'Battuta') and target then
                                    helpers['queue'].add(bp.JA['Battuta'], player)
                                end
                    ...
                    if self.getSetting('HATE') and target then
                        ...
                        if player.main_job == "RUN" then
                            ...
                            -- FLASH.
                            if helpers['actions'].canCast() and helpers['actions'].isReady('MA', "Flash") then
                                helpers['queue'].addToFront(bp.MA["Flash"], target)
                            
                            -- FOIL.
                            elseif helpers['actions'].canCast() and helpers['actions'].isReady('JA', "Foil") then
                                helpers['queue'].addToFront(bp.MA["Foil"], player)
                            ...
                            if helpers['actions'].canAct() and (os.clock()-timers.hate) > self.getSetting('HATE DELAY') then
                                ...
                                -- VALIANCE.
                                elseif target and helpers['actions'].isReady('JA', "Valiance") and active > 0 then
                                    helpers['queue'].addToFront(bp.JA["Valiance"], player)
                                    timers.hate = os.clock()
                                    
                                -- LIEMENT.
                                elseif target and helpers['actions'].isReady('JA', "Liement") and active > 0 then
                                    helpers['queue'].addToFront(bp.JA["Liement"], player)
                                    timers.hate = os.clock()
                    ...
                    if self.getSetting('BUFFS') then
                        ...
                        if player.main_job == 'RUN' then
                            ...
                            if target then
                                ...
                                -- PHALANX.
                                if helpers['actions'].canCast() and not helpers['buffs'].buffActive(116) and helpers['actions'].isReady('MA', "Phalanx") then
                                    
                                    if helpers['actions'].canAct() and self.getSetting('EMBOLDEN') == "Phalanx" and not helpers['buffs'].buffActive(534) and helpers['actions'].isReady('JA', "Embolden") then
                                        helpers['queue'].add(bp.JA["Embolden"], player)
                                ...
                                -- CRUSADE.
                                elseif helpers['actions'].canCast() and not helpers['buffs'].buffActive(289) and helpers['actions'].isReady('MA', "Crusade") then
                                    helpers['queue'].add(bp.MA["Crusade"], player)
                                    
                                -- TEMPER.
                                elseif helpers['actions'].canCast() and not helpers['buffs'].buffActive(432) and helpers['actions'].isReady('MA', "Temper") then
                                    
                                    if helpers['actions'].canAct() and self.getSetting('EMBOLDEN') == "Temper" and not helpers['buffs'].buffActive(534) and helpers['actions'].isReady('JA', "Embolden") then
                                        helpers['queue'].add(bp.JA["Embolde"], player)
                                ...
                                -- REGEN IV.
                                elseif helpers['actions'].canCast() and not helpers['buffs'].buffActive(42) and helpers['actions'].isReady('MA', "Regen IV") then
                                    
                                    if helpers['actions'].canAct() and self.getSetting('EMBOLDEN') == "Regen IV" and not helpers['buffs'].buffActive(534) and helpers['actions'].isReady('JA', "Embolden") then
                                        helpers['queue'].add(bp.JA["Embolde"], player)
                                        helpers['queue'].add(bp.MA["Regen IV"], player)
                                    else
                                        helpers['queue'].add(bp.MA["Regen IV"], player)
                                    end
                                    
                                -- REFRESH.
                                elseif helpers['actions'].canCast() and not helpers['buffs'].buffActive(43) and helpers['actions'].isReady('MA', "Refresh") then
                                    helpers['queue'].add(bp.MA["Refresh"], "me")
                                ...
                                elseif helpers['actions'].canCast() and self.getSetting('SPIKES') ~= "None" and not helpers['buffs'].buffActive(34) and not helpers['buffs'].buffActive(35) and not helpers['buffs'].buffActive(38) then
                                    ...
                                    if helpers['actions'].isReady('MA', self.getSetting('SPIKES')) then
