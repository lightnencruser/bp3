                ...
                elseif player.status == 0 then
                    ...
                    if self.getSetting('JA') and helpers['actions'].canAct() then
                        ...
                        if player.main_job == 'COR' then
                            ...
                            -- FOLD LOGIC.
                            if helpers['buffs'].buffActive(309) and helpers['actions'].isReady(bp, 'JA', 'Fold') then
                                helpers["queue"].add(bp, bp.JA["Fold"], player)
                            end
                    ...
                    if self.getSetting('BUFFS') then
                        ...
                        -- COR/.
                        if player.main_job == "COR" and helpers['actions'].canAct() then
                            ...
                            -- If Double-Up is currently active.
                    ...
                    if self.getSetting('RA') and helpers['equipment'].ammo.en ~= nil then
