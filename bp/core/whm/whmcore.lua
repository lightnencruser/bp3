                ...
                if player.status == 1 then
                    ...
                    if self.getSetting('JA') and helpers['actions'].canAct() then
                        ...
                        if player.main_job == 'WHM' then
                            ...
                            -- AFFLATUS.
                            if self.getSetting('MISERY') and not helpers['buffs'].buffActive(418) and helpers['actions'].isReady(bp, 'JA', "Afflatus Misery") then
                                helpers['queue'].add(bp, bp.JA["Afflatus Misery"], player)

                            elseif not self.getSetting('MISERY') and not helpers['buffs'].buffActive(417) and helpers['actions'].isReady(bp, 'JA', "Afflatus Solace") then
                                helpers['queue'].add(bp, bp.JA["Afflatus Solace"], player)
                        ...
                        elseif player.sub_job == "SCH" then
                            ...
                            if self.getSetting('SUBLIMATION') then
                                ...
                                elseif not helpers['buffs'].buffActive(187) and helpers['buffs'].buffActive(188) and helpers['actions'].isReady(bp, 'JA', "Sublimation") then
                                    helpers['queue'].addToFront(bp, bp.JA["Sublimation"], player)
                        ...
                        if player.main_job == 'WHM' and helpers['actions'].canCast() then
                            ...
                            if player.sub_job == 'SCH' then
                                ...
                                if (helpers['buffs'].buffActive(358) or helpers['buffs'].buffActive(359)) then
                                    ...
                                    -- PROTECT.
                                    elseif not helpers['buffs'].buffActive(40) and helpers['actions'].isReady(bp, 'MA', "Protectra V") then
