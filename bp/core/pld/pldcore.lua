                ...
                if player.status == 1 then
                    ...
                    if self.getSetting('BUFFS') then
                        ...
                        if player.main_job == 'PLD' then
                            ...
                            -- PROTECT.
                            if helpers['actions'].isReady(bp, "MA", "Protect V") and not helpers['buffs'].buffActive(40) then
                                helpers["queue"].add(MA["Protect V"], player)
                            
                            -- SHELL.
                            elseif helpers['actions'].isReady(bp, "MA", "Shell IV") and not helpers['buffs'].buffActive(41) then
                                helpers["queue"].add(MA["Shell IV"], player)
                            ...
                            elseif not helpers['buffs'].buffActive(274) then
                                ...
                                if self.getSetting('JOB POINTS') < 100 and helpers['actions'].isReady(bp, "MA", "Enlight") then
                                    helpers["queue"].add(MA["Enlight"], player)

                                elseif helpers['actions'].isReady(bp, "MA", "Enlight II") then
                                    helpers["queue"].add(MA["Enlight II"], player)

                                end

                            -- CRUSADE.
                            elseif helpers['actions'].isReady(bp, "MA", "Crusade") and not helpers['buffs'].buffActive(289) then
                                helpers["queue"].add(MA["Crusade"], player)

                            -- PHALANX.
                            elseif helpers['actions'].isReady(bp, "MA", "Phalanx") and not helpers['buffs'].buffActive(116) then
                                helpers["queue"].add(MA["Phalanx"], player)
