                ...
                if player.status == 1 then
                    ...
                    if self.getSetting('JA') and helpers['actions'].canAct() then
                        ...
                        if player.main_job == 'MNK' and helpers['actions'].canCast() then
                            ...
                            -- CHAKRA.
                            if player['vitals'].hpp < 40 and helpers['actions'].isReady('JA', "Chakra") then
                    ...
                    if bp.helpers['buffs'].enabled then
                        ...
                        if player.main_job == 'MNK' and helpers['actions'].canCast() and target and bp.helpers['target'].canEngage(target) and target.status == 1 then
                            ...
                            -- DODGE.
                            elseif not helpers['buffs'].buffActive(60) and helpers['actions'].isReady('JA', "Dodge") then
                                helpers['queue'].add(bp.JA["Dodge"], player)

                            -- IMPETUS.
                            elseif not helpers['buffs'].buffActive(406) and not helpers['buffs'].buffActive(461) and helpers['actions'].isReady('JA', "Impetus") then
                                helpers['queue'].add(bp.JA["Impetus"], player)

                            -- FOOTWORK.
                            elseif not helpers['buffs'].buffActive(406) and not helpers['buffs'].buffActive(461) and helpers['actions'].isReady('JA', "Footwork") and not helpers['actions'].isReady('JA', "Impetus") then
